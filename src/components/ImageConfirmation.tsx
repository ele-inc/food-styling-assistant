...
const REVISION_OPTIONS = [
	{
		...
		icon: Utensils,
		label: "お皿を変えたい",
		placeholder: "例：もっと和風のお皿、白い丸皿など",
	},
	{
		type: "arrangement" as const,
		icon: ChefHat,
		label: "盛り付けを変えたい",
		placeholder: "例：もっと立体的に、量を増やすなど",
	},
	{
		type: "props" as const,
		icon: Sparkles,
		label: "小物を変えたい",
		placeholder: "例：箸を追加、ナプキンを変えるなど",
	},
	{
		type: "color" as const,
		icon: Palette,
		label: "色味を変えたい",
		placeholder: "例：もっと明るく、暖かみのある色になど",
	},
	{
		type: "other" as const,
		icon: Edit3,
		label: "その他",
		placeholder: "自由に修正内容を記入してください",
	},
];
...
export default function ImageConfirmation({
	...
	const selectedOption = REVISION_OPTIONS.find(
			...
			<div className="p-4 border-t border-gray-100">
				{!showRevisionForm ? (
					...
					<div className="space-y-4">
						<p className="text-gray-700 font-medium">何を修正しますか？</p>
