...
import { Check, ChefHat, Utensils, Soup, Salad } from 'lucide-react';
...
export default function DishSelector({ dishes, onSelect, maxSelection = 3 }: DishSelectorProps) {
          ...
          return (
            <div key={category}>
              <div className="flex items-center gap-2 mb-2">
                <span className={`px-2 py-0.5 rounded-full text-xs font-medium flex items-center gap-1 ${categoryColors[category] || categoryColors['その他']}`}>
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-emerald-600 mt-1">✨ {dish.appeal}</p>
                        </div>
                        {isSelected && (
